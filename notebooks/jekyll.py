...
c.MarkdownExporter.template_path = ['/home/henry/.ipython/templates'] # point this to your jekyll template file
...
def path2support(path):
    ...
    return "{{ BASE_PATH }}/images/" + path #os.path.basename(path)

c.MarkdownExporter.filters = {'path2support': path2support}

if f:
    c.NbConvertApp.output_base = f.lower().replace(' ', '-')
    c.FilesWriter.build_directory = '/home/henry/projects/hinnefe2.github.io/notebooks' # point this to your build directory
